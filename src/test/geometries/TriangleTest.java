...
// ============ Equivalence Partitions Tests ==============
    ...
    public void testFindIntersections() {
        ...
        assertEquals("Ray intersects triangle - should return one point", new Point3D(0, 0, 0.5), tri.findIntersections((new Ray(new Point3D(0, 2, 0.5), new Vector(0, -1, 0)))).get(0).getPoint());
